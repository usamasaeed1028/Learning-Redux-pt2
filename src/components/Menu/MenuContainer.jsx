...
const menuItems = [
  { id: "m1", img: img1, name: "Whooper", price: "$10.9" },
  { id: "m2", img: img2, name: "Double Whooper", price: "$20.9" },
  { id: "m3", img: img3, name: "Bacon King", price: "$7.3" },
  { id: "m4", img: img4, name: "Cheese Crooisan", price: "$11.3" },
  { id: "m5", img: img5, name: "Single Mix n Match", price: "$17.3" },
  { id: "m6", img: img6, name: "Fully Loaded Crooisan", price: "$18.3" },
];
