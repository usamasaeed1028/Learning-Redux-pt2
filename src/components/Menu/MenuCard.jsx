...
const MenuCard = ({item}) => {
  return (
    ...
    <div className='flex justify-around gap-x-[40px]'>
        ...
        <h4 className='text-[16px] bg-[#290944] p-1 text-white rounded-[8px]'>{item.price}</h4>
        </div>
        <div><button className='border p-1 py-[8px] px-[80px] bg-[#290944] text-white hover:bg-transparent hover:text-black rounded-[8px]'>Add To Cart</button></div>
